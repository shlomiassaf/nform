...
import { DynamicFormComponent } from '@pebula/nform';

@Component({
  selector: 'pbl-example-form-wrapper',
  templateUrl: './form-wrapper.component.html',
  styleUrls: [ './form-wrapper.component.scss' ]
})
export class PblExampleFormWrapperComponent implements AfterContentInit, OnChanges {

  form: AbstractControl;
  @ContentChild(DynamicFormComponent, { static: false }) dynForm: DynamicFormComponent;

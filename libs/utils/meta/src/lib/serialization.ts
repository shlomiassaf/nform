 ...
 *
 */
export function autoDeserialize<T, Z>(plainObject: any, type: Z & Constructor<T>, instance: any = null, fallbackMapper: MapperFactory = directMapper): T {
...
(function (CLS: typeof TDMModelBase) {
  CLS.clone = function(resource: any, mapperFactory: MapperFactory = directMapper) {

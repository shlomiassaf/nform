...
export type MetadataCurriedCreate<TMetaArgs, TMetaClass> = ((
  alternateMeta?: MetaClassInstanceDetails<TMetaArgs, TMetaClass>
) => TMetaClass) & { meta: MetaClassInstanceDetails<TMetaArgs, TMetaClass> };

export type RegisterFn<TMetaArgs = any, TMetaClass = any> = (
  this: MetaClassMetadata<TMetaArgs, TMetaClass>,
  meta: MetaClassInstanceDetails<TMetaArgs, TMetaClass>
) => void;

export type ExtendFn<TMetaClass = any> = (
  from: Map<TdmPropertyKey, TMetaClass>,
  to?: Map<TdmPropertyKey, TMetaClass> | undefined,
  meta?: { from: Constructor<any>; to: Constructor<any> }
) => Map<TdmPropertyKey, TMetaClass> | undefined;

export type ExtendSingleFn<TMetaClass = any> = (
  from: TMetaClass,
  to?: TMetaClass | undefined,
  meta?: { from: Constructor<any>; to: Constructor<any> }
) => TMetaClass | undefined;

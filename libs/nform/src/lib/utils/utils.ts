 ...
 *
 * > This is a one-time enforcement, only for the next call. After `ctrl.updateValueAndValidity()` is invoked the enforcement is
 * removed, returning to native behavior.
 */

...
import { Prop, Model } from '@pebula/metap';
import { TargetMetaModifier } from '@pebula/metap/testing';
  ...
  describe('fw', () => {
    describe('@MetaClass()', () => {
      it('should be able to define metadata from a remote metadata host', () => {
        ...
        const extendMe = targetStore.getMetaFor(
          User,
          ExtendMeMetadata,
          'prop2'
        );
        ...
        expect(
          targetStore.getMetaFor(User, ExtendMeMetadata, 'prop1')
        ).toBeUndefined();
      });
      ...
      it('should be able to handle multiple defined metadata from a remote metadata host', () => {
        ...
        const extendMe1 = targetStore.getMetaFor(
          User,
          ExtendMeMetadata1,
          'prop4'
        );
      ...
      it('should reflect iterable proxy', () => {
        const arr = targetStore.getMetaFor<
          TopLevelMetadata,
          TopLevelMetadata[]
        >(User, <any>TopLevelMetadata, true);

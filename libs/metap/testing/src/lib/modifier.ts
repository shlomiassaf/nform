import { isFunction, Constructor } from '@pebula/utils';
import {
...
export class TargetMetaModifier<T, Z> {
  ...
  relation(key: keyof T, meta?: RelationMetadataArgs | false): this {
    ...
    if (typeof meta !== 'boolean') {
      TestTargetMetadata.addRelation(this.target, key.toString(), meta);
    }
  ...
  prop(
    key: keyof T,
    meta?: PropMetadataArgs | false | Function,
    type?: Function
  ): this {
    ...
    if (typeof meta !== 'boolean' && !isFunction(meta)) {
      TestTargetMetadata.addProp(this.target, key.toString(), meta);
    }
  ...
  exclude(key: keyof T, meta?: ExcludeMetadataArgs | false): this {
    ...
    if (typeof meta !== 'boolean') {
      TestTargetMetadata.addExclude(this.target, key.toString(), meta);
    }
    return this;
  }

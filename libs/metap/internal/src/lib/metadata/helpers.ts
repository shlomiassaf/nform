...
export function register(targetStore: TargetStore): void {
  /**
  ...
  extendHelpers.mergeMapArray = function<T extends BaseMetadata>(from: Map<TdmPropertyKey, T[]>,
                                                                 to: Map<TdmPropertyKey, T[]> | undefined): Map<TdmPropertyKey, T[]> {
    if (!to) {
...
declare module '../fw/metadata-framework/types' {
  interface MetaClassRegisterHelpers {
     ...
     * Handles both single and property style registration.
     */
    array<TMetaArgs, TMetaClass>(this: MetaClassMetadata<TMetaArgs, TMetaClass>, meta: MetaClassInstanceDetails<TMetaArgs, TMetaClass>): void;
  }
  ...
  interface MetaClassExtendHelpers {
    ...
    mergeMapArray<T extends BaseMetadata>(from: Map<TdmPropertyKey, T[]>, to: Map<TdmPropertyKey, T[]> | undefined): Map<TdmPropertyKey, T[]>;
  }
}
